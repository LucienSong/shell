System.register(["./application.db9e5.js"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_applicationDb9e5Js) {
      createApplication = _applicationDb9e5Js.createApplication;
    }],
    execute: function () {
